...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/Veriff/veriff-ios-spm", from: "10.0.0"),
        .package(url: "https://github.com/Veriff/veriff-nfc-ios-spm", from: "10.0.0"),
        ...
        .package(url: "https://github.com/iProov/ios-spm.git", from: "13.1.1"),
    ],
    targets: [
        // The actual binary XCFramework
        .binaryTarget(
            name: "IDmeSDK",
            url: "https://github.com/IDme/idme-mobilesdk-artifacts/releases/download/iOS-v0.9.1/IDmeSDK-v0.9.1.xcframework.zip",
            checksum: "3d99eca4e64c50ce30a959eda98fd76c5e92287caf1eca3419a0e47a26988e61"
        ),
